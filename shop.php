...
echo '<li class="show"><a href="shop.php">Store</a></li>';
...
echo '<h2>accessories <span>store</span></h2>';
echo '<nav aria-label="breadcrumb">';
echo '<ol class="breadcrumb">';
echo '<li class="breadcrumb-item"><a href="home.php">Home</a></li>';
echo '<li class="breadcrumb-item"><a href="#">About</a></li>';
...
echo '';
echo '<!-- shop-area -->';
echo '<section class="shop-area pt-120 pb-90">';
echo '<div class="container">';
echo '<div class="row">';
echo '<div class="col-lg-4 col-sm-6">';
echo '<div class="accessories-item text-center mb-80">';
echo '<div class="accessories-thumb mb-30">';
echo '<a href="#"><img src="img/product/shop_item01.jpg" alt=""></a>';
echo '</div>';
echo '<div class="accessories-content">';
echo '<h5><a href="#">';
?>                                
                                    <?php
