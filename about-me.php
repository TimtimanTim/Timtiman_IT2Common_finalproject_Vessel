...
echo '';
echo '</li>';
echo '<li class="show"><a href="#">About</a>';
echo '<ul class="submenu">';
echo '<li class="active"><a href="about-us.php">our story</a></li>';
...
echo '<h2>my <span>story</span></h2>';
echo '<nav aria-label="breadcrumb">';
echo '<ol class="breadcrumb">';
echo '<li class="breadcrumb-item"><a href="home.php">Home</a></li>';
echo '<li class="breadcrumb-item"><a href="#">Team</a></li>';
echo '<li class="breadcrumb-item active" aria-current="page">MY STORY</li>';
echo '</ol>';
echo '</nav>';
echo '</div>';
echo '</div>';
...
echo '';
echo '<!-- *************************************';
echo '*********** Begin body content ***********';
echo '************************************** -->';
echo '<div id="body-content" style="padding-top: 0px;">';
echo '';
echo '';
echo '';
echo '<section id="about-me-section" class="about-me-simple">';
echo '<div class="about-me-inner">';
echo '<div class="split-box about-me">';
echo '<div class="container-fluid">';
echo '<div class="row">';
echo '<div class="row-lg-height">';
echo '';
echo '';
echo '<div class="col-lg-6 col-lg-height split-box-image no-padding bg-image" style="background-image: url(img/images/me-3.jpg); background-position: 50% 50%;">';
echo '';
echo '';
echo '<div class="sbi-height full-height-vh"></div>';
echo '';
echo '</div>';
echo '';
echo '';
echo '<div class="col-lg-6 col-lg-height col-lg-middle no-padding">';
echo '';
echo '';
echo '<div class="split-box-content sb-content-right shifted-left">';
echo '';
echo '';
echo '<div class="tt-heading">';
echo '<div class="tt-heading-inner">';
echo '<h1 class="tt-heading-title">Timothy John Timtiman</h1>';
echo '<div class="tt-heading-subtitle" style="color: black">Chief Executive Director of the Vessel company</div>';
...
echo '<p style="text-align: justify; color: black">I am the CEO and leader of the organization, and I take that responsibility seriously. Just Kidding, I am Timothy John Timtiman a BSIT 2E Student from Marinduque State College.';
echo 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam accusamus delectus, laborum laboriosam neque accusantium dolore repellendus iure eius iste. Voluptates, fugit enim illum voluptatum debitis culpa veniam asperiores ut.';
echo '</p>';
echo '</div>';
echo '';
echo '<a href="game-overview.php" class="btn btn-primary margin-top-20">Be our partner</a>';
echo '<a href="#" class="btn btn-dark margin-top-20">View All My Work</a>';
echo '';
echo '<div class="signature">';
echo '<img class="signature-dark" src="img/images/signature-dark.png" alt="">';
echo '';
echo '</div>';
echo '';
echo '</div>';
...
echo '';
echo '</div>';
echo '<!-- End body content -->';
echo '';
echo '<!-- footer-area -->';
echo '<footer style="padding-top: 50px">';
...
echo '<p>Vessel the best game reviewing website.</p>';
