						...
						<div class="container-fluid">
							<div class="row">
								<div class="row-lg-height">
									...
									<div class="col-lg-6 col-lg-height split-box-image no-padding bg-image" style="background-image: url(img/images/me-3.jpg); background-position: 50% 50%;">
										...
										<div class="split-box-content sb-content-right shifted-left">
											...
											<div class="tt-heading">
												<div class="tt-heading-inner">
													<h1 class="tt-heading-title">Timothy John Timtiman</h1>
													<div class="tt-heading-subtitle" style="color: black">Chief Executive Director of the Vessel company</div>
													<hr class="hr-short">
												</div> 
											</div>
											...
											<div class="margin-top-30">
												<p style="text-align: justify; color: black">I am the CEO and leader of the organization, and I take that responsibility seriously. Just Kidding, I am Timothy John Timtiman a BSIT 2E Student from Marinduque State College.
													Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam accusamus delectus, laborum laboriosam neque accusantium dolore repellendus iure eius iste. Voluptates, fugit enim illum voluptatum debitis culpa veniam asperiores ut.
												</p>
											</div>

											<a href="game-overview.php" class="btn btn-primary margin-top-20">Be our partner</a>
											<a href="#" class="btn btn-dark margin-top-20">View All My Work</a>

											<div class="signature">
												<img class="signature-dark" src="img/images/signature-dark.png" alt="">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="footer-widget mb-50">
                                ...
                                <div class="footer-text">
                                    <p>Vessel the best game reviewing website.</p>
